...
<div class="ms-board-line-box">
	<c:forEach var="like" items="${communityLikeList.content}" varStatus="status">
		<c:if test="${status.index < 3}">
			<div class="ms-board-img-size-box">
		         <div class="ms-board-img-box">
		         	<a href="/community/${like.board.id}">
		         		<img src="/upload/${like.board.imageUrl}" class="ms-board-img">
		         	</a>
		         </div>
		     </div>
		</c:if>
